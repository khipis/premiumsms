...
public class CodeVerifier3PLNTest {
    ...
    public void shouldRecognizeValidCodeLive() throws PremiumSmsException {
        ...
        softAssertion.assertThat(response.getCost()).isEqualTo(THREE_PLN_GROSS_VALUE);
        softAssertion.assertThat(response.getVerificationStatus()).isEqualTo(VerificationStatus.SUCCESS);
    ...
    private void invalidResponseAssert(Response response, FailureReason invalidPartnerId) {
        ...
        softAssertion.assertThat(response.getVerificationStatus()).isEqualTo(VerificationStatus.FAILURE);
